...
\begin{itemize}
\item Rendezvous which are used to match  publishers and subscribers of information, each of them is identified by a globally unique identifier. The information items required to perform this matching exists in the Rendezvous Points (RP).
