...
\item In order to allow communicate and cooperate with each other requires interoperability between them. There are three different says that allows devices to cooperate:
\begin{itemize}
\item Fixed standardized protocol, in which we set some technologies, protocols and data formats in order to use them across the system.
...
\item Use interaction bridges that map between different approaches and protocols
\end{itemize}
